...
insert into job (name, description, type)
values
    ('Software Engineer', 'Develops and maintains software applications', 'AVAILABLE'),
    ('Sales Representative', 'Generates leads and closes sales with clients', 'AVAILABLE'),
    ('Marketing Manager', 'Oversees marketing campaigns and strategy', 'AVAILABLE'),
    ('HR Specialist', 'Manages employee relations and recruitment', 'NOT_AVAILABLE'),
    ('Financial Analyst', 'Analyzes financial data and prepares reports', 'NOT_AVAILABLE'),
    ('Project Manager', 'Coordinates project delivery and team management', 'AVAILABLE'),
    ('Data Scientist', 'Analyzes complex data sets and creates models', 'NOT_AVAILABLE'),
    ('Customer Support', 'Provides technical support to customers', 'AVAILABLE'),
    ('Product Manager', 'Drives product strategy and development', 'NOT_AVAILABLE'),
    ('Operations Manager', 'Oversees daily business operations', 'AVAILABLE');
